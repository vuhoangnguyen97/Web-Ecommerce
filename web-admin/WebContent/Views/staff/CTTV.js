...
function luu2() {
    ...
    if(txt.disabled == false && txt1.disabled == false && txt2.disabled == false && txt3.disabled == false && txt4.disabled == false && txt5.disabled == false && txt7.disabled == false && txt8.disabled == false)
    {
        txt.disabled = true;
        txt1.disabled = true;
        txt2.disabled = true;
