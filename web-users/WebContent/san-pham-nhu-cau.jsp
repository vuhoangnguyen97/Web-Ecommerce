		               ...
		               <form action="themGioHang?id=${dssp_nhucau.ma_san_pham}" method="post">
		                  <div class="col-md-4 col-sm-6">
		                    	<div class="products">
	                                ...
	                                <div class="thumbnail"><a href="xemChiTietSanPhamServlet?id=${dssp_nhucau.ma_san_pham}"><img src="data:image/jpeg;base64,${dssp_nhucau.hinh_anh}" alt="Product Name"></a></div>
