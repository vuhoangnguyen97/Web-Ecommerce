...
<html>
   <head>
      ...
      <link rel="stylesheet" type="text/css" href="xacnhantoken.css">
    </head>
<body id="home">
<div class="wrapper">    
...
<div class="page-index">
        <div class="container">
            <p>
              <a style="color:white;" href="trang-chu.jsp">Trang chủ</a> - <a style="color:white;" href="#"> Chi Tiết Đơn Hàng</a> - <a style="color:white;" href="#">Xác nhận mã</a>
            </p>
          </div>
    </div>
                    ...
                    <div class="col-md-12">
                        <div class="xacnhan">
                            <table class="table table-responsive">
                                <form action="xacNhanToken" method="POST" class="form-control">
                                    <tr>
                                        <td>
                                            <div id="txtThongBao">Mời bạn nhập lại mã xác nhận!</div>
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        <th>Mã xác nhận: </th>
                                        <td>
                                            <input type="text" class="txtNhap" name="txtMaXacNhan">
                                        </td>
                                    </tr>
                                    <tr>
                                        <td></td>
