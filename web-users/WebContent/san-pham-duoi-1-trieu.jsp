		            	...
		            	<form action="themGioHang?id=${ds_duoi1Trieu.ma_san_pham}" method="post">      
		                  <div class="col-md-4 col-sm-6">
		                    	<div class="products">
	                                ...
	                                <div class="thumbnail"><a href="xemChiTietSanPhamServlet?id=${ds_duoi1Trieu.ma_san_pham}"><img src="data:image/jpeg;base64,${ds_duoi1Trieu.hinh_anh}" alt="Product Name"></a></div>
