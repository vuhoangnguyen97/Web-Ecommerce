	                  ...
	                  <form action="themGioHang?id=${ds_phukien.ma_san_pham}" method="post">
		                  <div class="col-md-4 col-sm-6">
		                    	<div class="products">
	                                ...
	                                <div class="thumbnail"><a href="xemChiTietSanPhamServlet?id=${ds_phukien.ma_san_pham}"><img src="data:image/jpeg;base64,${ds_phukien.hinh_anh}" alt="Product Name"></a></div>
