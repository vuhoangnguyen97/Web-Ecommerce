	                                    ...
	                                    <div class="cart-item">
	                                       <div class="image"><img src="data:image/jpeg;base64," alt=""></div>
			                                       <div class="item-description">
			                                          <p class="name"></p>
			                                          <p>Số Lượng: <span class="light-red"></span></p>
			                                       </div>
			                                       <div class="right">
			                                          <p class="price">22.490.000 ₫</p>
...
<div class="page-index">
        <div class="container">
            <p>
              <a style="color:white;" href="trang-chu.jsp">Trang chủ</a> - <a style="color:white;" href="#"> Chi Tiết Đơn Hàng</a> - <a style="color:white;" href="#">Tạo mật khẩu mới</a>
            </p>
          </div>
    </div>
                    ...
                    <div class="col-md-12">
                        <div class="xacnhan">
                            <table class="table table-responsive">
                                <form action="updatePassword" name="xacnhanpassword" method="POST" class="form-control">
                                    
                                    <tr>
                                        <td>
                                            <div id="txtThongBao">Mời bạn nhập lại password mới!</div>
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        <th>Mật khẩu mới: </th>
                                        <td>
                                            <input type="password" name="txtMatKhauMoi" class="txtNhap">
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input type="password"name="txtMatKhauMoiRepeat" class="txtNhap">
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        <td></td>
                                        <td id="td_cot">
                                            <input type="submit" id="btThanhToan" class=" btn btn-primary" value="Xác nhận">
                                        </td>
                                    </tr>
                                </form>
                            </table>
